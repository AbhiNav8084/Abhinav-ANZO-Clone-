...
const Page2 = () => {
    ...
    return (
        <div id='section2' className='bg-white text-center  text-black'>
            <h3 className='text-gray-500 text-xl p-14 font-[anzo4]'>© 2024 Anzo.Studio® | Designed And Developed | Clone by Abhinav</h3>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo6] uppercase leading-[35vw]'>IMPACTFUL</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo6] uppercase leading-[35vw]'>DESIGN</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo6] uppercase leading-[35vw]'>IS THE</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[42vw] text-black font-[anzo6] uppercase leading-[35vw]'>DESIGN</h1>
            </div>
